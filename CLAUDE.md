...
Step-by-step recipes (new workspace, add a screen/flowplan step, write a workspace screen, add a simulator control, add a feature panel tab) live in the `flowkit-common-tasks` skill — invoked automatically when performing one of these tasks.
