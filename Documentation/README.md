...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [FLOWKIT.md](FLOWKIT.md)       | The platform itself — structure, `@flowkit`/`@workspace` aliases, kit system, canvas + simulator, mock db, theming, feedback, entry guards, export vs build, and the agent bootstrap system. **Start here.** |
