...
| [FLOWLENS.md](FLOWLENS.md)     | Session recording (FlowTracer) + replay & analytics (FlowLens) — event types, build gating (`VITE_ENABLE_FLOWLENS`), the committed session library, and the reports/heatmap surfaces.                         |
