...
> This is a product/UX-facing view. The engineering-facing feature registry (status, subsystem, phase) lives at `Documentation/product/vision/FEATURES.md` — that one is actively maintained; this one is a point-in-time snapshot and won't be kept in sync automatically.
