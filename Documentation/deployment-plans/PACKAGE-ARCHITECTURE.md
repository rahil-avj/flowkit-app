...
> Audience: whoever picks up development on the git-dep/npm-package effort next. This is a technical reference for _how the system works and why_, not a plan or a status report. For those, see:
>
> - [think-thrugh-what-we-snug-thacker.md](./think-thrugh-what-we-snug-thacker.md) — the original plan + phase-by-phase annotations of what shipped
> - [gap-analysis-2026-07-01.md](./gap-analysis-2026-07-01.md) — audit of plan vs. actual state
> - [flowkit-package-author-guide.md](./flowkit-package-author-guide.md) — consumer-facing docs for someone _using_ the published package
>
> Current branch: `flowkit/Package`, held separate from `r/deployBuild` pending full testing (not merged yet — that's a deliberate decision, not an oversight).
