...
- **Use:** `defineFlow({ id, name, steps[], homeScreen? })` — authored in `flowStories/<flow>.ts`
...
- **From:** `src/modes/flowlens/library/test/`
...
>
> **To remove a flow or screen**, delete the folder manually: `rm -rf workspaces/test/flows/<flow>/`
